...
`;
  ...
  it('extracts alphanumeric flight codes that start with a digit (e.g. 3T, J4)', () => {
    const autoPayloadText = `معلومات الرحلة ملاحظة: يجب ان يكون البرنامج يوم واحد على الاقل او اكثر (24/08/2026) رحلة الوصول طريقة السفر اختر تاريخ الوصول الذي ستصل فيه إلى المملكة العربية السعودية مع طريقة السفر. هذا التاريخ سيحدد بداية رحلتك. تاريخ الوصول وسيلة السفر السفر الجويالنقل البحريالنقل البري packages.journey قادم من السودان, الخرطوم ذاهب إلى المملكة العربية السعودية, جدة رقم الرحلة 3T-0204 المطار مطار الملك عبد العزيز الدولي الخطوط الجوية تــاركــو للطيران الصالة الصالة الشمالية وقت الوصول 17
15 نوع الرحلة رحلات مجدوله استعراض الرحلات الوجهة (مكة المكرمة) (2026-08-24 - 2026-08-26) الفنادق اسم الفندق/ المستضيف تاريخ الدخول تاريخ المغادرة مدة الاقامة سعة الغرفة السعر فندق سما البيت الفندقية08/24/202608/26/20262 10 510 ر.سالخدمات الإثرائية الخدمة نوع الخدمة تاريخ الزيارة الوقت المرشد السعر جبل النور وغار حراءمواقع التاريخية2026-08-2508
13:00هيثم15 ر.سالخدمات الإضافية التفاصيل السعر مزارات20 ر.س اضافة محطه للرحلة (27/08/2026) رحلة المغادرة طريقة السفر تاريخ المغادرة سيتم تحديده تلقائيًا بناءً على أخر وجهة. تاريخ المغادرة وسيلة السفر السفر الجويالنقل البحريالنقل البري packages.journey مغادر من المملكة العربية السعودية, جدة ذاهب إلى السودان, بورسودان رقم الرحلة J4-0605 المطار مطار الملك عبد العزيز الدولي الخطوط الجوية بدر الصالة الصالة الشمالية وقت المغادرة 14
25 نوع الرحلة رحلات مجدوله استعراض الرحلات عودة التالي ملخص معلومات الرحلة مسار الرحلة تاريخ الوصول (السفر الجوي) 24-8-2026 محطات الرحلة مكة المكرمة تاريخ المغادرة (السفر الجوي) 27-8-2026`;
    ...
    expect(departure?.flight).toBe('J4-0605');
  });
...
30 نوع الرحلة رحلات مجدوله استعراض الرحلات عودة التالي ملخص معلومات الرحلة مسار الرحلة تاريخ الوصول (السفر الجوي) 20-7-2026 محطات الرحلة مكة المكرمة تاريخ المغادرة (السفر الجوي) 31-7-2026`;
  ...
  it('auto payload capture: uses flight arrival date instead of first hotel entry date', () => {
    const autoPayloadText = `معلومات الرحلة ملاحظة: يجب ان يكون البرنامج يوم واحد على الاقل او اكثر (07/07/2026) رحلة الوصول طريقة السفر اختر تاريخ الوصول الذي ستصل فيه إلى المملكة العربية السعودية مع طريقة السفر. هذا التاريخ سيحدد بداية رحلتك. تاريخ الوصول وسيلة السفر السفر الجويالنقل البحريالنقل البري packages.journey قادم من كينيا, نيروبي ذاهب إلى المملكة العربية السعودية, جدة رقم الرحلة SV-0430 المطار مطار الملك عبد العزيز الدولي الخطوط الجوية السعوديه الصالة الصالة 1 وقت الوصول 05
53 نوع الرحلة رحلات مجدوله استعراض الرحلات الوجهة (مكة المكرمة) (2026-07-08 - 2026-07-11) الفنادق اسم الفندق/ المستضيف تاريخ الدخول تاريخ المغادرة مدة الاقامة سعة الغرفة السعر شركة الوفاق الدولية للمقاولات07/08/202607/11/20263 2 1130 ر.سالخدمات الإثرائية الخدمة نوع الخدمة تاريخ الزيارة الوقت المرشد السعر جبل النور وغار حراءمواقع التاريخية2026-07-0908
13:00هيثم15 ر.س اضف خدمات إضافية اضافة محطه للرحلة (11/07/2026) رحلة المغادرة طريقة السفر تاريخ المغادرة سيتم تحديده تلقائيًا بناءً على أخر وجهة. تاريخ المغادرة وسيلة السفر السفر الجويالنقل البحريالنقل البري packages.journey مغادر من المملكة العربية السعودية, جدة ذاهب إلى كينيا, نيروبي رقم الرحلة SV-0431 المطار مطار الملك عبد العزيز الدولي الخطوط الجوية السعوديه الصالة الصالة 1 وقت المغادرة 20
50 نوع الرحلة رحلات مجدوله استعراض الرحلات يجب تغيير تاريخ الوصول واختيار تاريخ اليوم أو تاريخ مستقبلي عودة التالي ملخص معلومات الرحلة مسار الرحلة تاريخ الوصول (السفر الجوي) 7-7-2026 محطات الرحلة مكة المكرمة تاريخ المغادرة (السفر الجوي) 11-7-2026`;

    const rows = parseItineraryText(autoPayloadText, groupInfo);
    const arrival = rows.find(r => r.Column1 === 'وصول');

    expect(arrival?.date).toBe('07/07/2026');
    expect(arrival?.time).toBe('05:53');
    expect(arrival?.flight).toBe('SV-0430');
    expect(arrival?.to).toBe('شركة الوفاق الدولية للمقاولات (مكة المكرمة)');
  });
